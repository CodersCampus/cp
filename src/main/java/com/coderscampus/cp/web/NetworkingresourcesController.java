...
public class NetworkingresourcesController {
    ...
    public String home(ModelMap model) {
        List<Networkingresources> networkingresourcess = networkingresourcesService.findAll();
        model.put("networkingresourcess", networkingresourcess);
        model.addAttribute("pageTitle", "Networkingresources Read");
    ...
    public String getCreate(ModelMap model) {
        ...
        model.addAttribute("pageTitle", "Networkingresources Create");
        model.put("isNetworkingresources", true);
    ...
    public String fetch(ModelMap model, @PathVariable Long id) {
        ...
        model.put("networkingresources", networkingresources);
        model.addAttribute("pageTitle", "Networkingresources Update");
        model.put("isNetworkingresources", true);
